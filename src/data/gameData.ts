...
export const INITIAL_COUNTRIES: Country[] = [
  ...
  },
  {
    ...
    specialTraitDesc: 'Enquanto a Rússia não for convertida, a violência cresce +0.8 por ciclo. Se a Rússia for convertida, a violência cai -0.5 por ciclo.',
  ...
  },
  {
    ...
    specialTraitDesc: 'Quando o líder for convertido, a Indonésia e o Japão recebem +1.5% de conversão por ciclo, irradiando fé pelo Pacífico.',
